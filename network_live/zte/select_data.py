...
wcdma_cells_select = """
    SELECT
        ...
        WM_CONCAT(R_ULOGICALCELL_F_V1.DESCRIPTION) AS CONCATENATED_DESCR
    FROM
        NAF_CM.V_CM_UTRAN_CELL_V3
    LEFT JOIN OMMR.R_UCELINFOFDD_F_V1
        ON NAF_CM.V_CM_UTRAN_CELL_V3.NEID = OMMR.R_UCELINFOFDD_F_V1.MEID 
        AND NAF_CM.V_CM_UTRAN_CELL_V3.CID = OMMR.R_UCELINFOFDD_F_V1.UUTRANCELLFDD
    LEFT JOIN OMMR.R_ULOGICALCELL_F_V1
        ON NAF_CM.V_CM_UTRAN_CELL_V3.NEID = OMMR.R_ULOGICALCELL_F_V1.MEID 
        AND NAF_CM.V_CM_UTRAN_CELL_V3.CID = 
            SUBSTR(OMMR.R_ULOGICALCELL_F_V1.REFUUTRANCELLFDD, 
                INSTR(OMMR.R_ULOGICALCELL_F_V1.REFUUTRANCELLFDD, ',', -1) + 1)
    GROUP BY
        V_CM_UTRAN_CELL_V3.NEID,
        V_CM_UTRAN_CELL_V3.NODEBNAME,
        V_CM_UTRAN_CELL_V3.USERLABEL,
